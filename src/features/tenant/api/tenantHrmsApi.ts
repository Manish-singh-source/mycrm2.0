...
export const tenantHrmsApi = {
  ...
  leave: {
    ...
    calendar: (query?: ApiQuery) => client().get<{ events: HrmsRecord[] }>('/leave/calendar', { query }),
  ...
  payroll: {
    ...
    downloadPayslip: (id: string | number) => client().get('/payroll/payslips/' + encodeURIComponent(String(id)) + '/download'),
  ...
  holidays: {
    ...
    deleteCalendar: (id: string) => client().delete('/holiday-calendars/' + encodeURIComponent(id)),
